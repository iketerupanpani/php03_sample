...
if ($status==false) {
    ...
    while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        $view .= '<a href="detail.php?id='.$result['id'].'" class="badge badge-pill badge-warning">Edit</a>'; 
        $view .= '<a href="delete.php?id='.$result['id'].'" class="badge badge-pill badge-danger">Delete</a>';
        $view .= '</li>';
    }
}
?>
